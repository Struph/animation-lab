...
1. Fraktion waehlen (Allianz/Horde)
2. Auf **Buch oeffnen** klicken
3. Unten auf die Lesezeichen klicken -> Seite blaettert um

## Dateien

- `codex-demo.html` = alles in einer Datei (empfohlen)
- `index.html` + `styles.css` + `script.js` = gleiche Demo in getrennten Dateien
